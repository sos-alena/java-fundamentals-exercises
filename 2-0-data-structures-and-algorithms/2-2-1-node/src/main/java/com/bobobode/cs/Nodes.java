...
public class Nodes {
    ...
    public static <T> Node<T> pairOf(T firstElement, T secondElement) {
        Node<T> newFirstElement = new Node<>(firstElement);
        newFirstElement.next = new Node<>(secondElement);
    ...
    public static <T> Node<T> closedPairOf(T firstElement, T secondElement) {
        Node<T> newFirstElement = new Node<>(firstElement);
        Node<T> newSecondElement = new Node<>(secondElement);

        newFirstElement.next = newSecondElement;
        newSecondElement.next = newFirstElement;
